...
export default function ContentSetupGuide({ drupalBaseUrl }: ContentSetupGuideProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-blue-50 to-blue-50 flex items-center justify-center p-4">
      <div className="max-w-3xl w-full bg-white rounded-2xl shadow-xl p-8">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold bg-gradient-to-r from-emerald-600 via-blue-600 to-blue-600 bg-clip-text text-transparent mb-2">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-4">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex-1 bg-blue-700 text-white px-4 py-3 rounded-lg font-medium text-center hover:bg-blue-700 transition-colors flex items-center justify-center gap-2"
                >
