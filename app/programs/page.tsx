...
export const metadata: Metadata = {
  title: 'Programs | Lakeview School District - K-12',
  description: 'Explore academic and extracurricular programs at Lakeview School District, including STEM, performing arts, athletics, and early learning.',
}
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-primary-100 max-w-3xl mx-auto">
              Discover our comprehensive K-12 programs designed to inspire and empower every student.
            </p>
          </div>
        </div>
      </section>
