          ...
          <ErrorBoundary>
            <article className="bg-white rounded-2xl shadow-md shadow-primary-200/50 overflow-hidden">
              ...
              <div className="p-6 md:p-8">
                <h1 className="font-display text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold text-gray-900 mb-4 md:mb-6">{title}</h1>
                <div className="prose prose-sm sm:prose lg:prose-lg max-w-none prose-headings:font-display prose-a:text-primary-600" dangerouslySetInnerHTML={{ __html: bodyHtml }} />
              </div>
            </article>
          </ErrorBoundary>
        </main>
